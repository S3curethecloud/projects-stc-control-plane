async function loadHeatmap() {
  ...
  try {
    ...
    tbody.innerHTML = `
      <tr>
        <td colspan="5">Heatmap telemetry unavailable</td>
      </tr>
    `;

    document.getElementById("total_tokens_issued").textContent = "--";
    document.getElementById("total_policy_denied").textContent = "--";
    document.getElementById("total_sessions_revoked").textContent = "--";
  }
}
